public class Edificio implements ImpactoEcologico {
    ...
    double eficienciaEnergia, double mantenimientoAnual, int vidaUtil, 
    double impactoDemolicion) {
    ...
    public double calcularImpactoEcologico() {
        ...
        return emisionesConstruccion + (eficienciaEnergia * mantenimientoAnual) + (impactoDemolicion / vidaUtil);
    }
