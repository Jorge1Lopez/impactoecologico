public class Auto implements ImpactoEcologico {
    ...
    public Auto(double emisionesProduccion, String tipoCombustible, 
            double eficienciaCombustible, double kilometrajeAnual, 
            int duracion, double emisionesReciclaje) {
